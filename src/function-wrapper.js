  ...
  var output = (function() {
    ...
    function FunctionWrapper(info) {
      ...
      if (typeof func !== "function") {
        throw {
          name: "FunctionWrapper:MissingFuncError",
          message:
            "FunctionWrapper({~}) argument requires 'func' property as a function"
        };
      }
      ...
      if (typeof before === "undefined") {
        before = FunctionWrapper.noop;
      }
      if (typeof after === "undefined") {
        after = FunctionWrapper.noop;
      }
      ...
      return {
        newFunc: function() {
          before.apply(
            "beforeScope" in info ? beforeScope : scope,
            Array.prototype.slice.call(arguments)
          );
          if (override !== true) {
            func.apply(
              "funcScope" in info ? funcScope : scope,
              Array.prototype.slice.call(arguments)
            );
          }
          after.apply(
            "afterScope" in info ? afterScope : scope,
            Array.prototype.slice.call(arguments)
          );
        },
        oldFunc: (function(ff) {
